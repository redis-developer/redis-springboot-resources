...
To see how to implement short-term memory (or chat history) with Spring AI, refer to the dedicated recipe: ![Chat History with Spring AI](../chat-history-with-spring-ai/README.md)
