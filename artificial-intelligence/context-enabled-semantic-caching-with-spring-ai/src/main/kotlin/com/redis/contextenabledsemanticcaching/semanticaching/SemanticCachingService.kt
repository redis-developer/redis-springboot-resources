package com.redis.contextenabledsemanticcaching.semanticaching
...
class SemanticCachingService(
    ...
    fun getFromCache(prompt: String, similarityThreshold: Double): Pair<String?, String?> {
        ...
        if (results.isNotEmpty()) {
            if (similarityThreshold < (results[0].score ?: 0.0)) {
                ...
                return Pair(results[0].text as String,results[0].metadata["answer"] as String)
            }
        }
