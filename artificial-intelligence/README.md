...
|---------------------------------------|-------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| Agent Long-term Memory with Spring AI | Demonstrates how to implement short-term and long-term memory for AI agents using Redis vector capabilities | [agent-long-term-memory-with-spring-ai](./agent-long-term-memory-with-spring-ai) |
| Chat History with Spring AI           | Demonstrates how to implement chat history for AI agents using Spring AI's Advisor Abstraction              | [chat-history-with-spring-ai](./chat-history-with-spring-ai)                     |
