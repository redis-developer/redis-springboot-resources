...
public class RedisConnectionFactoryConfig {
  ...
  @Primary
  @Bean(name = "readJedisConnectionFactory")
  ...
  @Bean(name = "writeRedisModulesClient")
  ...
  @Bean(name = "readRedisModulesClient")
  ...
  @Bean(name = "writeRedisModulesOperations")
  ...
  @Bean(name = "readRedisModulesOperations")
  ...
  @Bean(name = "writeRedisOperations")
  ...
  @Bean(name = "writeKeyValueTemplate")
  ...
  @Bean(name = "readKeyValueTemplate")
